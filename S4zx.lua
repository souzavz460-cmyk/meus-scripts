-- ========================================================
-- S4ZX HUB v2.5.3 - FULL COMPLETO + KEYBIND + PLAYER LIST
-- Logo ID: rbxassetid://79731590930393
-- ========================================================
...
VersionText.Text = "VERSION 2.5 OFFICIAL"
...
-- ========================================================
-- CONSTRUÇÃO DAS ABAS (COM CALLBACKS REAIS)
-- ========================================================
...
AddButton(ArmasPage, "Cor da Arma (Vermelho)", function()
...
UserInputService.InputBegan:Connect(function(input, gameProcessedEvent)
    ...
    if input.UserInputType == Enum.UserInputType.Keyboard then
        ...
        elseif input.KeyCode == MenuKeybind then
            ...
            OpenButton.Visible = false -- PC não usa a bolinha
        end
    end
end)
...
-- Armas: Tamanho da Arma
task.spawn(function()
    while true do
        task.wait(0.5)
        local tool = LocalPlayer.Character and LocalPlayer.Character:FindFirstChildWhichIsA("Tool")
        if tool then tool:ScaleTo(state.armaSize) end
    end
end)
...
-- Config: Anti Live (esconde menu se houver indicador de live)
task.spawn(function()
    while true do
        task.wait(1)
...
print("[S4ZX HUB v2.5.3] 100% Carregado e Funcional!")
